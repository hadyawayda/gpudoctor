      ...
      <section className="mx-auto max-w-6xl px-6 pb-24 lg:px-10 xl:px-16">
        <div className="grid gap-6 lg:grid-cols-2">
          <div className="rounded-3xl border border-emerald-500/20 bg-[#0b1f17]/70 p-8 text-sm text-emerald-50/80">
            ...
            <ul className="mt-5 space-y-3 text-xs text-emerald-50/70">
          ...
          <div className="rounded-3xl border border-emerald-500/20 bg-[#0b1f17]/70 p-8 text-sm text-emerald-50/80">
            ...
            <div className="mt-6 rounded-2xl border border-emerald-500/20 bg-[#091810] p-4 text-xs text-emerald-50/70">
              <p className="font-semibold text-emerald-200">Reminder</p>
              <p className="mt-2">
