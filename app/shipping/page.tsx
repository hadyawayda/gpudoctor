      ...
      <section className="mx-auto max-w-5xl px-6 pb-24 lg:px-10 xl:px-16">
        <div className="space-y-8 text-sm leading-7 text-slate-300">
          <article className="rounded-3xl border border-primary-500/20 bg-background-section/70 p-6">
            <h2 className="text-lg font-semibold text-primary-300">Inbound shipments</h2>
            <p className="mt-3">
          ...
          <article className="rounded-3xl border border-primary-500/20 bg-background-section/70 p-6">
            <h2 className="text-lg font-semibold text-primary-300">Return shipments</h2>
            <p className="mt-3">
          ...
          <article className="rounded-3xl border border-primary-500/20 bg-background-section/70 p-6">
            <h2 className="text-lg font-semibold text-primary-300">Loss or damage</h2>
            <p className="mt-3">
              Contact <a className="underline decoration-primary-400" href="mailto:shipping@gpudoctor.com">shipping@gpudoctor.com</a> within 24 hours
          ...
          <article className="rounded-3xl border border-primary-500/20 bg-background-section/70 p-6">
            <h2 className="text-lg font-semibold text-primary-300">Processing timelines</h2>
            <p className="mt-3">
          ...
          <article className="rounded-3xl border border-primary-500/20 bg-background-section/70 p-6">
            <h2 className="text-lg font-semibold text-primary-300">International logistics</h2>
            <p className="mt-3">
          ...
          <article className="rounded-3xl border border-primary-500/20 bg-background-section/70 p-6">
            <h2 className="text-lg font-semibold text-primary-300">Packaging checklist</h2>
