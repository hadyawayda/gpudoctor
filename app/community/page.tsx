      ...
      <section className="mx-auto grid max-w-6xl gap-10 px-6 pb-24 lg:grid-cols-[1.1fr_0.9fr] lg:px-10 xl:px-16">
        <div className="space-y-6">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur">
            <h2 className="text-2xl font-semibold text-emerald-300">Forum highlights</h2>
            ...
            <div className="mt-6 grid gap-6 sm:grid-cols-2">
              {forumHighlights.map((highlight) => (
                <article key={highlight.name} className="rounded-2xl border border-emerald-500/10 bg-emerald-500/5 p-5 text-sm text-slate-200">
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8 text-sm text-slate-200">
            <h2 className="text-2xl font-semibold text-emerald-300">Atlas AI copilot</h2>
        ...
        <aside className="space-y-6">
          <div className="rounded-3xl border border-emerald-500/10 bg-slate-900/70 p-6 text-sm text-slate-200">
            <h2 className="text-lg font-semibold text-emerald-200">Events & workshops</h2>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-6 text-sm text-slate-200">
            <h2 className="text-lg font-semibold text-emerald-200">Marketplace integrations</h2>
            <p className="mt-3 text-xs text-slate-300">
