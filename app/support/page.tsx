      ...
      <section className="mx-auto max-w-6xl px-6 pb-24 lg:px-10 xl:px-16">
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="space-y-8">
            <article className="rounded-3xl border border-emerald-500/25 bg-[#0c1f17]/80 p-6">
              <h2 className="text-xl font-semibold text-emerald-200">Response timelines</h2>
            ...
            <article className="rounded-3xl border border-emerald-500/25 bg-[#0c1f17]/80 p-6">
              <h2 className="text-xl font-semibold text-emerald-200">How we protect your hardware</h2>
              <ul className="mt-4 space-y-3 text-sm text-emerald-50/85">
            ...
            <article className="rounded-3xl border border-emerald-500/25 bg-[#0c1f17]/80 p-6">
              <h2 className="text-xl font-semibold text-emerald-200">Need personal assistance?</h2>
              <p className="mt-3 text-sm text-emerald-50/85">
                Email <Link className="underline decoration-emerald-400" href="mailto:support@gpudoctor.com">support@gpudoctor.com</Link> or
                call <Link className="underline decoration-emerald-400" href="tel:+18005551234">+1 (800) 555-1234</Link>. Our team replies within one business hour during the workweek.
              </p>
              <p className="mt-3 text-sm text-emerald-50/85">
                For existing customers, log into <Link className="underline decoration-emerald-400" href="/portal">portal.gpudoctor.com</Link> to
                view tickets, upload photos, or approve quotes securely.
              </p>
            </article>
          </div>
          <aside className="space-y-6">
            <div className="rounded-3xl border border-emerald-500/25 bg-[#0c1f17]/80 p-6 text-sm text-emerald-50/85">
              <h3 className="text-lg font-semibold text-emerald-200">Policy library</h3>
            ...
            <div className="rounded-3xl border border-emerald-500/25 bg-[#0c1f17]/80 p-6 text-sm text-emerald-50/85">
              ...
              <ul className="mt-3 space-y-3">
                <li>
                  <Link className="hover:text-emerald-200" href="/repair-requests">
                    Start a repair intake
                  </Link>
                </li>
                <li>
                  <Link className="hover:text-emerald-200" href="/store">
                    Shop certified hardware
                  </Link>
                </li>
                <li>
                  <Link className="hover:text-emerald-200" href="/sell">
                    Arrange a sale or trade-in
                  </Link>
                </li>
                <li>
                  <Link className="hover:text-emerald-200" href="/faq">
