      ...
      <section className="mx-auto max-w-5xl px-6 pb-24 lg:px-10 xl:px-16">
        <div className="space-y-8 text-sm leading-7 text-slate-300">
          <div className="rounded-3xl border border-primary-500/20 bg-background-section/70 p-6">
            <h2 className="text-lg font-semibold text-primary-300">Information we collect</h2>
          ...
          <div className="rounded-3xl border border-primary-500/20 bg-background-section/70 p-6">
            <h2 className="text-lg font-semibold text-primary-300">How your data is used</h2>
            <p className="mt-3">
          ...
          <div className="rounded-3xl border border-primary-500/20 bg-background-section/70 p-6">
            <h2 className="text-lg font-semibold text-primary-300">Security practices</h2>
            <p className="mt-3">
          ...
          <div className="rounded-3xl border border-primary-500/20 bg-background-section/70 p-6">
            <h2 className="text-lg font-semibold text-primary-300">Retention & control</h2>
            <p className="mt-3">
              ...
              <a className="ml-1 underline decoration-primary-400" href="mailto:privacy@gpudoctor.com">privacy@gpudoctor.com</a>.
            </p>
            <p className="mt-3">
          ...
          <div className="rounded-3xl border border-primary-500/20 bg-background-section/70 p-6">
            <h2 className="text-lg font-semibold text-primary-300">Your rights</h2>
            <ul className="mt-4 space-y-3">
            ...
            <p className="mt-3">
              ...
              <a className="ml-1 underline decoration-primary-400" href="mailto:privacy@gpudoctor.com">privacy@gpudoctor.com</a> or review
              additional resources in our <Link className="underline decoration-primary-400" href="/support">support center</Link>.
            </p>
          </div>
          <div className="rounded-3xl border border-primary-500/20 bg-background-section/70 p-6">
            <h2 className="text-lg font-semibold text-primary-300">International customers</h2>
            <p className="mt-3">
          ...
          <div className="rounded-3xl border border-primary-500/20 bg-background-section/70 p-6">
            <h2 className="text-lg font-semibold text-primary-300">Cookies & analytics</h2>
            <p className="mt-3">
