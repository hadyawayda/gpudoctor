...
const Home = () => {
  ...
  return (
    <main className="bg-[#0a1612] text-emerald-50">
      ...
      <section className="bg-[#0d1f19] py-20">
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-6">
                {landingHighlights.map(({ title, description }) => (
                  <div key={title} className="rounded-2xl border border-nvidia-500/15 bg-[#0d1f19]/70 p-6 hover:border-nvidia-500/30 transition-colors">
                    <h3 className="text-lg font-semibold text-nvidia-200">{title}</h3>
                    <p className="mt-3 text-sm text-emerald-50/80">{description}</p>
                  </div>
                ))}
              </div>
            </div>
            <div className="rounded-3xl border border-nvidia-500/25 bg-[#0d1f19]/80 p-8 shadow-[0_20px_60px_-30px_rgba(118,185,0,0.3)]">
              <h3 className="text-xl font-semibold text-nvidia-300">Repair journey overview</h3>
              <ol className="mt-6 space-y-6 text-sm text-emerald-50/80">
                {repairMilestones.map(({ title, description, tip }, index) => (
                  <li key={title} className="relative pl-10">
                    <span className="absolute left-0 top-0 flex h-7 w-7 items-center justify-center rounded-full bg-gradient-to-br from-nvidia-500 to-emerald-400 text-sm font-semibold text-[#0a1612]">
                      {index + 1}
                    </span>
                    <div>
                      <h4 className="font-semibold text-nvidia-200">{title}</h4>
                      <p className="mt-2 leading-6">{description}</p>
                      {tip ? <p className="mt-1 text-xs text-nvidia-300/80">Tip: {tip}</p> : null}
                    </div>
                  </li>
                ))}
              </ol>
      ...
      <section className="bg-[#0a1612] py-24">
        <div className="mx-auto max-w-6xl px-6 lg:px-10 xl:px-16">
          <div className="flex flex-col items-start justify-between gap-6 pb-12 lg:flex-row">
            <div>
              <h2 className="text-3xl font-semibold text-nvidia-300">Service menu highlights</h2>
          ...
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            {featuredServices.map(({ name, description, price, turnaround, badge }) => (
              <article key={name} className="relative rounded-3xl border border-nvidia-500/20 bg-[#0d1f19]/70 p-6 hover:border-nvidia-500/40 transition-all hover:shadow-lg hover:shadow-nvidia-500/10">
                {badge ? (
                  <span className="absolute right-6 top-6 rounded-full bg-nvidia-500/90 px-3 py-1 text-xs font-semibold text-[#0a1612]">
                    {badge}
                  </span>
                ) : null}
                <h3 className="text-lg font-semibold text-nvidia-200">{name}</h3>
                <p className="mt-3 text-sm leading-6 text-emerald-50/80">{description}</p>
                <div className="mt-6 flex items-center justify-between text-sm font-semibold text-nvidia-300">
                  <span>{price}</span>
      ...
      <section className="bg-[#0d1f19] py-24">
        <div className="mx-auto max-w-6xl px-6 lg:px-10 xl:px-16">
          <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="space-y-6">
              <h2 className="text-3xl font-semibold text-nvidia-300">Pricing, fees, and guarantees</h2>
              <div className="grid gap-6 sm:grid-cols-2">
                <div className="rounded-3xl border border-nvidia-500/20 bg-[#0d1f19]/70 p-6 text-sm text-emerald-50/80 hover:border-nvidia-500/40 transition-colors">
                  <h3 className="text-lg font-semibold text-nvidia-200">Diagnostic fee</h3>
                  <p className="mt-3">
            ...
            <div className="rounded-3xl border border-nvidia-500/20 bg-[#0d1f19]/70 p-8">
              <h3 className="text-xl font-semibold text-nvidia-300">Customer protections</h3>
              <ul className="mt-6 space-y-4 text-sm text-emerald-50/80">
                {forumHighlights.map(({ name, description }) => (
                  <li key={name} className="rounded-2xl border border-nvidia-500/15 bg-[#0a1612]/80 p-4 hover:border-nvidia-500/30 transition-colors">
                    <p className="text-sm font-semibold text-nvidia-200">{name}</p>
              ...
              <Link
                href="/support"
                className="mt-6 inline-flex items-center text-sm font-semibold text-nvidia-300 hover:text-nvidia-200"
              >
      ...
      <section className="bg-[#0a1612] py-24">
        <div className="mx-auto max-w-6xl px-6 lg:px-10 xl:px-16">
          <div className="grid gap-12 lg:grid-cols-[1.15fr_0.85fr]">
            <div>
              <h2 className="text-3xl font-semibold text-nvidia-300">Marketplace & store highlights</h2>
              ...
              <div className="mt-8 grid gap-6">
                {featuredListings.map(({ id, title, price, description, stats, location, refurbishedByDoctor, includesRefurbOption }) => (
                  <article key={id} className="rounded-3xl border border-nvidia-500/20 bg-[#0d1f19]/70 p-6 hover:border-nvidia-500/40 transition-colors">
                    <div className="flex items-center justify-between">
                      <h3 className="text-lg font-semibold text-nvidia-200">{title}</h3>
                      <span className="text-sm font-semibold text-nvidia-300">{price}</span>
                    </div>
                    <p className="mt-3 text-sm text-emerald-50/80">{description}</p>
                    <p className="mt-4 text-xs text-nvidia-300/80">{stats}</p>
                    <div className="mt-4 flex flex-wrap gap-3 text-xs text-emerald-50/75">
                      <span className="rounded-full bg-nvidia-500/10 px-3 py-1 border border-nvidia-500/20">{location}</span>
                      {refurbishedByDoctor ? (
                        <span className="rounded-full bg-nvidia-500/20 px-3 py-1 text-nvidia-200 border border-nvidia-500/30">GPU Doctor Certified</span>
                      ) : null}
                      {includesRefurbOption ? (
                        <span className="rounded-full bg-emerald-400/20 px-3 py-1 text-emerald-200 border border-emerald-400/30">Refurbish add-on available</span>
                      ) : null}
                    </div>
                  </article>
                ))}
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <Link className="text-sm font-semibold text-nvidia-300 hover:text-nvidia-200" href="/marketplace">
                  Browse the full marketplace →
                </Link>
                <Link className="text-sm font-semibold text-nvidia-300 hover:text-nvidia-200" href="/store">
                  Shop the store →
                </Link>
              </div>
            </div>
            <aside className="flex flex-col gap-8">
              <div className="rounded-3xl border border-nvidia-500/20 bg-[#0d1f19]/70 p-6 hover:border-nvidia-500/40 transition-colors">
                <h3 className="text-lg font-semibold text-nvidia-300">Sell or consign</h3>
                ...
                <Link className="mt-4 inline-flex items-center text-sm font-semibold text-nvidia-300 hover:text-nvidia-200" href="/sell">
                  Sell your GPU →
                </Link>
              </div>
              <div className="rounded-3xl border border-nvidia-500/20 bg-[#0d1f19]/70 p-6 hover:border-nvidia-500/40 transition-colors">
                <h3 className="text-lg font-semibold text-nvidia-300">Customer portal</h3>
                <p className="mt-3 text-sm text-emerald-50/80">
                ...
                <Link className="mt-4 inline-flex items-center text-sm font-semibold text-nvidia-300 hover:text-nvidia-200" href="/portal">
                  Explore the portal →
                </Link>
              </div>
            </aside>
      ...
      <section className="bg-[#0d1f19] pb-24 pt-12">
        <div className="mx-auto max-w-5xl px-6 text-center lg:px-10 xl:px-16">
          <h2 className="text-3xl font-semibold text-nvidia-300">Get started today</h2>
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-3">
            {landingCtas.map(({ title, description, href }) => (
              <Link
                key={href}
                href={href}
                className="group flex flex-col justify-between rounded-3xl border border-nvidia-500/20 bg-[#0a1612]/70 p-6 text-left transition hover:border-nvidia-500/50 hover:shadow-lg hover:shadow-nvidia-500/10"
              >
                <div>
                  <h3 className="text-lg font-semibold text-nvidia-200">{title}</h3>
                  <p className="mt-3 text-sm text-emerald-50/80">{description}</p>
                </div>
                <span className="mt-6 text-sm font-semibold text-nvidia-300 group-hover:text-nvidia-200">Open →</span>
              </Link>
            ))}
          </div>
        </div>
