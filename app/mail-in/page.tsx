      ...
      <section className="mx-auto max-w-6xl gap-10 px-6 pb-24 lg:grid lg:grid-cols-[1.1fr_0.9fr] lg:px-10 xl:px-16">
        <div className="space-y-6">
          <div className="rounded-3xl border border-emerald-500/20 bg-[#0b1f17]/70 p-8">
            ...
            <ol className="mt-4 space-y-4 text-sm text-emerald-50/80">
          ...
          <div className="rounded-3xl border border-emerald-500/20 bg-[#0b1f17]/70 p-8 text-sm text-emerald-50/80">
            ...
            <ul className="mt-4 space-y-2 text-xs text-emerald-50/70">
        ...
        <aside className="mt-10 space-y-6 lg:mt-0">
          <div className="rounded-3xl border border-emerald-500/20 bg-emerald-500/10 p-6 text-sm text-emerald-200">
            <p className="text-lg font-semibold text-emerald-50">Portal oversight</p>
          ...
          <div className="rounded-3xl border border-emerald-500/20 bg-[#0b1f17]/70 p-6 text-sm text-emerald-50/80">
            <h2 className="text-lg font-semibold text-emerald-200">Documentation you receive</h2>
            <ul className="mt-4 space-y-2 text-xs text-emerald-50/70">
