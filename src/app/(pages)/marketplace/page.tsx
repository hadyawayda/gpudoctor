...
import { marketplaceListings } from "@data/site";
...
export const metadata: Metadata = {
  title: "Marketplace",
  description:
    "Filter certified GPU listings by brand, cooler type, fans, memory, and price. Add refurbish packages before shipping.",
};
      ...
      <section className="bg-background-base pb-24">
        <div className="mx-auto max-w-5xl px-6 text-center lg:px-10 xl:px-16">
          <h2 className="text-3xl font-semibold text-primary-300">
            Build smarter with marketplace integrations
          </h2>
          <p className="mt-4 text-sm text-slate-300">
            Sync purchases to your GPU Doctor account, track refurbish status,
            and drop components into the PC builder to see how they fit. Saved
            listings are available inside portal.gpudoctor.com for easy
