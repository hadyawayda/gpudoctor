...
import { forumHighlights } from "@data/site";

export const metadata: Metadata = {
  title: "Community",
  description:
    "Join the GPU Doctor forums, collaborate with technicians, and chat with the Atlas AI repair assistant.",
};
        ...
        <div className="space-y-6">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur">
            ...
            <p className="mt-3 text-sm text-slate-200">
              Dive into dedicated labs for signal integrity, firmware tuning,
              and thermal engineering. Experts and enthusiasts collaborate daily
              to extend the life of performance GPUs.
            </p>
            <div className="mt-6 grid gap-6 sm:grid-cols-2">
              {forumHighlights.map((highlight) => (
                <article
                  key={highlight.name}
                  className="rounded-2xl border border-primary-500/10 bg-primary-500/5 p-5 text-sm text-slate-200"
                >
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8 text-sm text-slate-200">
            ...
            <p className="mt-3 text-sm">
              Hosted on atlas.gpudoctor.com, our AI assistant triages issues,
              drafts repair tickets, and keeps your team updated in
              conversational threads.
            </p>
            <ul className="mt-5 space-y-3 text-xs text-slate-300">
              <li>
                • Upload oscilloscope captures and crash dumps for instant
                insights.
              </li>
              <li>• Generate RMA-ready documentation for enterprise teams.</li>
              <li>
                • Receive push notifications when technicians leave updates or
                require approval.
              </li>
            </ul>
            <Link
        ...
        <aside className="space-y-6">
          <div className="rounded-3xl border border-primary-500/10 bg-slate-900/70 p-6 text-sm text-slate-200">
            ...
            <p className="mt-3 text-xs text-slate-300">
              Monthly livestreams with technicians covering micro-soldering,
              VBIOS tuning, and immersion prep. Members can submit boards for
              live diagnostics.
            </p>
          </div>
          <div className="rounded-3xl border border-white/10 bg-white/5 p-6 text-sm text-slate-200">
            ...
            <p className="mt-3 text-xs text-slate-300">
              Link your community handle to marketplace listings to showcase
              refurbish certifications and gather feedback from buyers.
            </p>
            <Link
              href="/marketplace"
