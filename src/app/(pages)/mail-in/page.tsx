...
import { repairMilestones } from "@data/site";
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-3xl border border-primary-500/20 bg-background-section/70 p-8 text-sm text-slate-300">
            ...
            <p className="mt-3 text-sm">
              Use the original GPU box when possible, surround the card with
              anti-static foam, and avoid loose accessories. We return your GPU
              using the same protective materials plus tamper seals and a
              checklist of the work performed.
            </p>
            <ul className="mt-4 space-y-2 text-xs text-slate-400">
              <li>
                • Include screws, water block fittings, and backplates in
                labelled bags.
              </li>
              <li>
                • Photograph the board before shipping; we compare your photos
                with lab intake shots for accountability.
              </li>
              <li>
                • Print the prepaid label generated from your account dashboard
                or portal.gpudoctor.com.
              </li>
            </ul>
          </div>
        </div>
        <aside className="mt-10 space-y-6 lg:mt-0">
          <div className="rounded-3xl border border-primary-500/20 bg-secondary-500/10 p-6 text-sm text-primary-300">
            ...
            <p className="mt-3 text-xs text-primary-300/80">
              Intake photos, technician notes, and courier scans post
              automatically to your customer portal so you can audit every step.
            </p>
          </div>
          <div className="rounded-3xl border border-primary-500/20 bg-background-section/70 p-6 text-sm text-slate-300">
            <h2 className="text-lg font-semibold text-primary-300">
              Need expedited turnaround?
            </h2>
            <p className="mt-3 text-xs text-slate-400">
              Upgrade to the seven-day expedited lane during checkout or within
              the portal. We provide daily updates and refund the rush fee if
          ...
          <div className="rounded-3xl border border-primary-500/20 bg-background-section/70 p-6 text-sm text-slate-300">
            ...
            <ul className="mt-4 space-y-2 text-xs text-slate-400">
              <li>
                • Intake and completion photos time-stamped for your records.
              </li>
              <li>
                • Stress test results with sensor overlays proving stability.
              </li>
              <li>
                • Warranty certificates showing seven-day coverage and optional
                six-week extensions.
              </li>
            </ul>
          </div>
